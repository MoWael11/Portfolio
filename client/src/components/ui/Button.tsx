...
export const buttonVariants = cva(
  "active:sclae-95 inline-flex items-center justify-conter rounded-md text-sm font-medium transition-color duration-300 focus:outline-none border-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        default:
          "bg-[#F7F7F7] text-black hover:bg-dark-header hover:text-[#F7F7F7] hover:border-[#7E7E7E]",
      },
      size: {
